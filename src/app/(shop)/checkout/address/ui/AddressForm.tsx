    ...
    >
      <div className="flex flex-col mb-2">
        ...
        <input
          type="text"
          className={clsx(
            "p-2 border rounded-md bg-gray-200 focus:border-blue-500 focus:outline-none",
            {
      ...
      <div className="flex flex-col mb-2">
        ...
        <input
          type="text"
          className="p-2 border rounded-md bg-gray-200 focus:border-blue-500 focus:outline-none"
          {...register("address2")}
        />
      </div>
      ...
      <div className="flex flex-col mb-2 sm:mt-1">
        <div className="inline-flex items-center mb-10">
          ...
          <span className="ml-2">¿Recordad dirección?</span>
        </div>
